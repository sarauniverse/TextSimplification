...
if __name__ == '__main__':
    try:
        ...
        eval_report_folder = sys.argv[4]
    except:
        logging.error("Input parameters must be: " + sys.argv[0] 
            + "    <SOURCE_FILE>    <REFS_TSV>   <DIRECTORY_OF_PREDICTIONS> <EVAL_OUTPUT_FILE_PATH>")
        sys.exit(1)

    sari_file = eval_report_folder+"/prediction_sari_score.csv"
    bleu_file = eval_report_folder+"/prediction_bleu_score.csv"
